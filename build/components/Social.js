...
/*#__PURE__*/
function (_Component) {
  _inherits(SocialComponent, _Component);

  function SocialComponent() {
    _classCallCheck(this, SocialComponent);

    return _possibleConstructorReturn(this, _getPrototypeOf(SocialComponent).apply(this, arguments));
  }
