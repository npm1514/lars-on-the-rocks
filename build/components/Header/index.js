...
var _HeaderMobileMenu = _interopRequireDefault(require("./HeaderMobileMenu"));

var _HeaderDesktopMenu = _interopRequireDefault(require("./HeaderDesktopMenu"));
...
function (_Component) {
  ...
  function HeaderComponent(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "changeMenu", function () {
      _this.setState({
