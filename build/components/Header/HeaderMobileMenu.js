...
/*#__PURE__*/
function (_Component) {
  _inherits(HeaderMobileMenu, _Component);

  function HeaderMobileMenu() {
    _classCallCheck(this, HeaderMobileMenu);

    return _possibleConstructorReturn(this, _getPrototypeOf(HeaderMobileMenu).apply(this, arguments));
  }
